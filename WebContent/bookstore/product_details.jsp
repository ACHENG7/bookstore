...
<!-- Sidebar end=============================================== -->
    ...
    <li><a href="classify_type?type=all">图  书</a> <span class="divider">/</span></li>
    <li class="active">图 书 详 情 页</li>
    </ul>	
	<div class="row">	  
			<div id="gallery" class="span3">
            <a href="themes/images/products/large/l1.jpg" title="">
				<img src="themes/images/products/large/l1.jpg" style="width:100%" alt=""/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="themes/images/products/large/l1.jpg"> <img style="width:29%" src="themes/images/products/large/l1.jpg" alt=""/></a>
                   <a href="themes/images/products/large/l1.jpg"> <img style="width:29%" src="themes/images/products/large/l1.jpg" alt=""/></a>
                   <a href="themes/images/products/large/l1.jpg" > <img style="width:29%" src="themes/images/products/large/l1.jpg" alt=""/></a>
                  </div>
			...
			<div class="span6">
				<h3>${book.bookName}</h3>
				<small>作者:${book.bookAuthor}</small>
				<br/>
				<small>出版日期:${book.bookPublicDate}</small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span>￥${book.bookPrice}</span></label>
					<div class="controls">
					<input type="number" class="span1" placeholder="1"/>
					  <button type="submit" class="btn btn-large btn-primary pull-right"> 加 入 购 物 车 <i class=" icon-shopping-cart"></i></button>
					</div>
				  </div>
				</form>
				<hr class="soft clr"/>
				...
				<a class="btn btn-small pull-right" href="#detail">更 多 详 情 介 绍</a>
				<br class="clr"/>
            ...
            <ul id="productDetail" class="nav nav-tabs">
              <li class="active"><a href="#home" data-toggle="tab">图 书 详 情</a></li>
              <li><a href="#profile" data-toggle="tab">类 似图 书</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>图 书 信 息</h4>
				...
				<tbody>
				<tr class="techSpecRow"><th colspan="2">详情</th></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">书名: </td><td class="techSpecTD2">${book.bookName}</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">作者:</td><td class="techSpecTD2">${book.bookAuthor} </td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">出版日期:</td><td class="techSpecTD2">${book.bookPublicDate}</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">定价:</td><td class="techSpecTD2">${book.bookPrice}</td></tr>
		...
		<div class="tab-content">
	                ...
	                <hr class="soft"/>
		               <div class="row">	  
		            	...
		            	<div class="span4">
				            ...
				            <a class="btn btn-small pull-right" href="product_details.html">查 看 详 情</a>
			            	<br class="clr"/>
			           </div>
			           <div class="span3 alignR">
			                 ...
			                 <a href="product_details.html" class="btn btn-large btn-primary"> 加 入 <i class=" icon-shopping-cart"></i></a>
		   ...
		   <s:iterator  value="#request.booklist">
			<li class="span3">
			  <div class="thumbnail">
				<a href="product_details.html"><img src="themes/images/products/<s:property value="bookId" />.jpg" alt=""/></a>
				<div class="caption">
