...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">
		<div class="span4">
			...
			<form action="login" method="post">
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" id="UserName" placeholder="用户名" name="userName">
				</div>
			  </div>
			  <div class="control-group">
				<label class="control-label" for="passWord">密码</label>
				<div class="controls">
				  <input type="password" class="span3"  id="passWord" placeholder="密码" name="passWord">
				</div>
			  </div>
			  <div class="control-group">
				<div class="controls">
				  <button type="submit" class="btn">登录</button> <a href="forgetpass.html">忘记密码?</a>
				</div>
			  </div>
			</form>
		</div>
		...
		<div class="span4">
			<div class="well">
			<h5>创 建 您 的 帐 户</h5><br/>
			输入邮箱号创建你的用户.<br/><br/><br/>
			<form action="register.html" >
			  <div class="control-group">
				<label class="control-label" for="inputEmail0">E-mail 地址</label>
				<div class="controls">
				  <input class="span3"  type="text" id="inputEmail0" placeholder="Email">
				</div>
			  </div>
			  <div class="controls">
			  <button type="submit" class="btn block">创建账户</button>
			  </div>
			</form>
		</div>
		</div>
