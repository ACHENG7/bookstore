...
<!-- Sidebar end=============================================== -->
	<div class="span9">
    <ul class="breadcrumb">
		<li><a href="index.html">首 页</a> <span class="divider">/</span></li>
		<li class="active">特 价 图 书</li>
    </ul>
	<h4>尊 享 88 折 超 值 优 惠<small class="pull-right"> 共 有 ${booklist.size()} 本 </small></h4>	
	<hr class="soft"/>
...
<div class="tab-content">
	...
	<s:iterator  value="#application.bookSpecilList">
	    <hr class="soft"/>
		<div class="row">	  
			<div class="span2">
			<img src="themes/images/products/<s:property value="bookId"/>.jpg" alt=""/>
			</div>
			<div class="span4">
				<h3><s:property value="bookName"/></h3>				
				<hr class="soft"/>
				<h5>作者：<s:property value="bookAuthor"/> </h5>
				<h5>简介：</h5>
				<p>
...
<a href="compair.html" class="btn btn-large pull-right">收 藏 图 书</a>
